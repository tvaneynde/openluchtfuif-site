  ...
  return (
    <section className="hero" id="home" ref={heroRef}>
      <div className="hero-bg">
        <img
          src={`${import.meta.env.BASE_URL}assets/hero-dancers.webp`}
      ...
      <div className="hero-inner">
        ...
        <div className="hero-meta">
          <div className="meta-item" style={{ fontWeight: 700, fontSize: 18 }}>◉ Zaterdag 29 Augustus 2026</div>
          <div className="meta-item" style={{ fontWeight: 700, fontSize: 18 }}>◉ Vanaf 16:00</div>
        </div>
